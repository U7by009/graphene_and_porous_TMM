function TMM2(N,P,wavelength,Ef,T,gamma,indices,conductivity,layers,theta)
%% INSTRUCTIONS.
...
%
% example:TMM2(4,0.75,632.8,0.5,300,2*pi*(0.1e13),[1.61,1,2.56,1.333],[0,1,0,0],[NaN,0.34,1000,NaN],linspace(0*pi/180,85*pi/180,1000))
