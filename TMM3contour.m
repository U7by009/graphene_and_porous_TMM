function TMM3contour(N,P,wavelength,Ef,T,gamma,indices,conductivity,layers,theta)
%% INSTRUCTIONS.
...
%
% example:TMM3contour(4,linspace(0,1,100),632.8,[1.61,1,2.56,1.333],[0,1,0,0],[NaN,0.34,1000,NaN],linspace(0*pi/180,85*pi/180,1000))
