function TMM(N,P,wavelength,indices,layers,theta)
%% INSTRUCTIONS.
...
%
% example:TMM_contour(4,[0.45],632.8,[1.61,2.6+1.6i,2.56,1.333],[NaN,0.34,1000,NaN],linspace(0*pi/180,85*pi/180,1000))
